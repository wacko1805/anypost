...
$title = str_replace('>', '', str_replace('<', '', filter_input(INPUT_POST, 'title')));
$comment = str_replace('>', '', str_replace('<', '', filter_input(INPUT_POST, 'comment')));
$upload_time = str_replace('>', '', str_replace('<', '', filter_input(INPUT_POST, 'date')));
$display_time = str_replace('>', '', str_replace('<', '', filter_input(INPUT_POST, 'displaydate')));
if (!empty($title)){
if (!empty($comment)){
